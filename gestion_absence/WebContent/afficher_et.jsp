...
<%@page import="Beans.AjouterEtudiant"%>
                            ...
                            <table class="table table-bordered table-striped mt-3" id="productList">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Prenom</th>
                                        <th>Email</th>
                                        <th>Telephone_Etud</th>
                                        <th>Telephone_Parent</th>
                                        <th>Filiere</th>
                                        <th>Niveau</th>
                            	...
                            	try {
                            		...
                            		while(res.next()){
                            			...
                            			<td class="align-middle text-center">
                                         ...
                                         <a href='modetudiant.jsp?matricule=<%=res.getString(1)%>'><button class="btn btn-success"data-toggle="modal"  ><i class="fa fa-pencil"></i></button></a>
                                        </td>
                                </tr>
                                <% 
                            		}
