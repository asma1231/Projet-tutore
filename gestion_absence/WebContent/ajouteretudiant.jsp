        ...
        <div class="row header shadow-sm">
            ...
            <div class="col-sm-3 pl-0 text-center header-logo">
               <div class="bg-theme mr-3 pt-3 pb-2 mb-0">
                    <h3 class="logo"><a href="#" class="text-secondary logo"><i class="fa fa-rocket"></i>PROFIL ADMINISTRATEUR<span class="small"></span></a></h3>
               </div>
            </div>
            <!--Logo-->
                            ...
                            <div class="dropdown-menu dropdown-menu-left mt-10 animated zoomInDown" aria-labelledby="dropdownMenuLink3">
                                ...
                                <a href="#" class="dropdown-item">
                                   <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="mt-0"><strong></strong></h6></a>
                                            <p></p>
                       ...
                       <a href="affcher etudiant.jsp"> <button class="btn btn-theme" data-toggle="modal" data-target="#orderInfo">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                            ...
                            <form class="form-horizontal mt-4 mb-5" action="servajouter" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Prenom</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="prenom" class="form-control" id="input-3" placeholder="Prenom" />
                                    </div>
                                </div>
                              <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Email</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mail" class="form-control" id="input-3" placeholder="Email" />
                                    </div>
                              </div>
                              
                              <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Telephone-Etudia</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="teletu" class="form-control" id="input-3" placeholder="Telephone-Etudiant" />
                                    </div>
                              </div>
                              
                              <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Telephone-Parent</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="telepara" class="form-control" id="input-3" placeholder="Telephone-Parent" />
                                    </div>
                              </div>
                              

                                 <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Filiere</label>
                                
                                        <div class="col-sm-10">
                                    
                                  <select name="filiere" class="form-control" id="input-3" >
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-3">Niveau</label>
                                
                                        <div class="col-sm-10">
                                    
                                  <select name="niveau" class="form-control" id="input-3" >
