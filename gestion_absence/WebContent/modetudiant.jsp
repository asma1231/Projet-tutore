                    ...
                    <div class="col-sm-12">
                       ...
                       <a href="affcher etudiant.jsp"> <button class="btn btn-theme" data-toggle="modal" data-target="#orderInfo">
                        ...
                        <div class="mt-1 mb-3 p-3 button-container bg-white border shadow-sm">
                         <form class="form-horizontal mt-4 mb-5" action="EditServlet" method="POST">
                                ...
                                %>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="matricule" class="form-control" id="input-1" placeholder="Matricule " value='<%=rs.getString(1)%>'>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-sm-2" for="input-2">Nom</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="nom" class="form-control" id="input-2" placeholder="Nom Etudiant" value='<%=rs.getString(2)%>'>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="telephone" class="form-control" id="input-3" placeholder="telephone" value='<%=rs.getString(3)%>'>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <select name="classe" class="form-control" id="input-3" value='<%=rs.getString(4)%>'>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="tuteur" class="form-control" id="input-3" placeholder="tuteurs" value='<%=rs.getString(5)%>'>
                                    </div>
                                </div>
